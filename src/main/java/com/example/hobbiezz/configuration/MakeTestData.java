...
public class MakeTestData implements ApplicationRunner {
    ...
    public void makeMembers(){
        Person m1 = personRepository.save(new Person
                ("amanda@mail.dk", "Amanda", "Amandasen", "70121416"));
        Person m2 = personRepository.save(new Person
                ("casper@mail.co.uk", "Casper", "Caspersen", "88888888"));
        Person m3 = personRepository.save(new Person
                ("test@mail.com", "Test", "Test", "125"));


        Person m4 = personRepository.save(new Person
                ("sandy@mail.dk", "Sandy", "Svendsson", "76543"));
        Person m5 = personRepository.save(new Person
                ("karlsson@mail.co.uk", "Karl", "Karlsson", "2543"));
