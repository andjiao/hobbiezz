...
public class ValidationHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(com.example.hobbiezz.error.Client4xxException.class)
    public ResponseEntity<Map<String, String>> handleException(HttpServletRequest request, com.example.hobbiezz.error.Client4xxException e) {
